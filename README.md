...
***\< SpringFrog \>은(는) 정보주체의 개인정보 열람청구가 신속하게
처리되도록 노력하겠습니다.***
...
**① \< SpringFrog \>은(는) 아래와 같이 영상정보처리기기를 설치·운영하고
있습니다.**
...
열람.존재확인 청구서로 신청하여야 하며, 정보주체 자신이 촬영된 경우 또는
명백히 정보주체의 생명.신체.재산 이익을 위해 필요한 경우에 한해 열람을
허용함
